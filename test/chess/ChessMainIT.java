...
public class ChessMainIT {
    ...
    /**
     * Test of encrypt method, of class ChessMain.
     */
   /*@Test
    public void testEncrypt() throws Exception {
        ...
        String strKey = "";
        String expResult = "";
        String result = ChessMain.encrypt(strClearText, strKey);
    ...
    /**
     * Test of removeAndPasteNodeByRowColumnIndex2 method, of class ChessMain.
     */
    @Test
    public void testRemoveAndPasteNodeByRowColumnIndex2() {
        System.out.println("removeAndPasteNodeByRowColumnIndex2");
        int row = 0;
        int column = 0;
        int q = 0;
        int p = 0;
        GridPane gridPane = null;
        ChessMain instance = new ChessMain();
        instance.removeAndPasteNodeByRowColumnIndex2(row, column, q, p, gridPane);
        // TODO review the generated test code and remove the default call to fail.
